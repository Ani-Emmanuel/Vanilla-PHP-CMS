...
if (isset($_POST['post_comment'])) {
    ...
    $query .= "VALUES($p_id,'{$comment_author}','{$comment_email}','{$comment_content}','approved',now() ) ";
...
<?php 
$c_querry = "SELECT * FROM comments WHERE comment_post_id = {$p_id} ";
$c_querry .="AND comment_status = 'approved' ORDER BY comment_id DESC ";
$c_result = mysqli_query($connection,$c_querry);
if (!$c_result) {
    die('QUERY FAILED' . mysqli_error($connection));
}
